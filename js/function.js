...
jQuery(document).on("ready", function () {
  ...
  function collapseMenu() {
    jQuery(
      ".at-navigation ul li.menu-item-has-children, .at-navigation ul li.menu-item-has-mega-menu"
    ).prepend(
      '<span class="at-dropdowarrow"><i class="fa fa-angle-down"></i></span>'
    );
    jQuery(
      ".at-navigation ul li.menu-item-has-children span, .at-navigation ul li.menu-item-has-mega-menu span"
    ).on("click", function () {
  ...
  jQuery(function ($) {
    ...
    function columns(mega) {
      ...
      mega.children(".mega-menu-row").each(function () {
        columns = Math.max(
          columns,
          jQuery(this).children(".mega-menu-col").length
        );
      });
      return columns;
    }
  ...
  if (jQuery("#at-homeslidervone").length > 0) {
    ...
    var mySlider = jQuery("#at-homeslidervone")
      .pogoSlider({
        autoplay: false,
        responsive: true,
        targetHeight: 445,
        ...
        onSlideStart: function () {
          var currentIndex =
            jQuery('div[style*="opacity: 1"].pogoSlider-slide').index() + 1;
          jQuery("#at-homeslidervone + .at-counter").html(
            "<span>" + currentIndex + "</span><span>" + totalItems + "</span>"
          );
        },
      })
  ...
  if (jQuery("#at-homeslidervthree").length > 0) {
    var mySlider = jQuery("#at-homeslidervthree")
      .pogoSlider({
        autoplay: false,
        responsive: true,
        targetHeight: 445,
  ...
  if (jQuery("#at-homeslidervfour").length > 0) {
    var mySlider = jQuery("#at-homeslidervfour")
      .pogoSlider({
        autoplay: false,
        responsive: true,
        targetHeight: 445,
  ...
  if (jQuery("#at-homeslidervfive").length > 0) {
    var menu = [
      '<span>01</span><h2>Friendly Assistance</h2><div class="at-description"><p>Export Financial Advice</p></div>',
      '<span>02</span><h2>Money Care</h2><div class="at-description"><p>Finding your Next Advisor</p></div>',
      '<span>03</span><h2>Our Experience</h2><div class="at-description"><p>We have 15 years Experience</p></div>',
      '<span>04</span><h2>Clients Investment</h2><div class="at-description"><p>Doing the right thing</p></div>',
    ];
  ...
  if (jQuery("#at-homeslidervsix").length > 0) {
    var mySlider = jQuery("#at-homeslidervsix")
      .pogoSlider({
        autoplay: true,
        responsive: true,
        targetHeight: 445,
  ...
  if (jQuery("#at-featuresslider").length > 0) {
    ...
    function counter(event) {
      var totalItems = jQuery(
        "#at-featuresslider .owl-item:not(.cloned)"
      ).length;
      var currentIndex =
        jQuery("#at-featuresslider .owl-item.center").index() - 2;
      jQuery(".at-titleandbtn .at-counter").html(
        "<span>0" + currentIndex + "</span><span>0" + totalItems + "</span>"
      );
    }
  }
  /* -------------------------------------
  ...
  if (jQuery("#at-servicesslider").length > 0) {
    ...
    function counter(event) {
      var totalItems = jQuery(
        "#at-servicesslider .owl-item:not(.cloned)"
      ).length;
      var currentIndex =
        jQuery("#at-servicesslider .owl-item.center").index() - 2;
      jQuery(".at-servicesslidercounter").html(
        "<span>0" + currentIndex + "</span><span>0" + totalItems + "</span>"
      );
    }
  }
  ...
  if (jQuery(".at-testimonial3gridslider").length > 0) {
    ...
    function counter(event) {
      var totalItems = jQuery(
        ".at-testimonial3gridslider .owl-item:not(.cloned)"
      ).length;
      var currentIndex =
        jQuery(".at-testimonial3gridslider .owl-item.center").index() - 2;
      jQuery(".at-textimonialscounter").html(
        "<span>0" + currentIndex + "</span><span>0" + totalItems + "</span>"
      );
    }
  }
        ...
        datasets: [
          {
            ...
            backgroundColor: ["rgba(254, 96, 169, 0.2)"],
            borderColor: ["#fe60a9"],
            borderWidth: 2,
          },
          {
            ...
            backgroundColor: ["rgba(84, 181, 211, 0.2)"],
            borderColor: ["#54b5d3"],
            borderWidth: 2,
          },
        ],
  ...
  if (jQuery("#at-doughnutchartone").length > 0) {
    var doughnutchartone = document
      .getElementById("at-doughnutchartone")
      .getContext("2d");
    var at_doughnutchartone = new Chart(doughnutchartone, {
      ...
      data: {
        ...
        datasets: [
          {
            backgroundColor: ["#ffbf66", "#53b4d1", "#fe60a8"],
            data: [33, 33, 34],
          },
        ],
      },
  ...
  if (jQuery("#at-doughnutchartwo").length > 0) {
    var doughnutcharttwo = document
      .getElementById("at-doughnutchartwo")
      .getContext("2d");
  ...
  if (jQuery("#at-teamslider").length > 0) {
    ...
    function counter(event) {
      ...
      jQuery(".at-teamslidercounter").html(
        "<span>0" + currentIndex + "</span><span>0" + totalItems + "</span>"
      );
    }
  }
